...
const NewJobHeader = ({ onChangeStage }: INewJobHeader) => {
  return (
    <div className='fixed right-0 left-0 z-[999]'>
      <div className='bg-white drop-shadow-md flex'>
        <div className='max-w-screen-xl h-[200px] mx-auto pt-4 pb-6 flex-shrink-0'>
          <div className='w-full flex items-center justify-between mb-4'>
            <span className='text-2xl'>New Job</span>
            <div>
              <button
                type='button'
            ...
            <div className='flex items-start after:content-[""] after:h-[60%] after:w-[1px] after:bg-gray-400 after:ml-2 after:self-center'>
              ...
              >
                ...
                <p className={`${styles.section__description}`}>
                  Tells applicants about this role, including job title,
