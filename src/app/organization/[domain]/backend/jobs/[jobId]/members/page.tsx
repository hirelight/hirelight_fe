            ...
            <div className="p-6">
                <h1 className="text-xl font-medium text-neutral-800 flex items-center mb-8">
                    ...
                    <span className="relative group">
                        ...
                        <div className="absolute top-full mt-2 left-0 -translate-x-1/2 w-[360px] rounded-md border border-gray-200 p-4 bg-white shadow-lg opacity-0 invisible  group-hover:opacity-100 group-hover:visible transition-all duration-300 delay-300">
