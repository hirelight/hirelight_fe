      ...
      <section className='flex-1 flex flex-col justify-between items-center md:items-start self-stretch gap-10 md:gap-8 md:px-11 md:py-9'>
        <div className='text-center flex flex-col items-center md:items-start md:text-left'>
          <h1 className='text-4xl md:text-4xl font-semibold mb-6'>
            Nhận xét từ{' '}
            <span className={styles.title__gradient}>khách hàng</span>
          </h1>
        ...
        <div className='w-full flex justify-between '>
          ...
          <div className='flex flex-col items-center gap-4'>
            ...
            <p className='text-gray-700 text-base'>Based on 1,258 reviews</p>
          </div>
        </div>
          ...
          <div className='w-full bg-white rounded-lg p-4 flex items-start gap-3 drop-shadow-md'>
            ...
            <div className='flex flex-col items-start'>
              ...
              <p className='text-xs text-gray-500'>
                ...
                <span className='text-blue_primary_600'>Brator</span>
              </p>
            </div>
          </div>
          <div className='w-full bg-white rounded-lg p-4 flex items-start gap-3 drop-shadow-md'>
            ...
            <div className='flex flex-col items-start'>
              ...
              <p className='text-xs text-gray-500'>
                FODEN P. / Director At{' '}
                <span className='text-blue_primary_600'>Ecoland Resort</span>
              </p>
            </div>
          </div>
          <div className='w-full bg-white rounded-lg p-4 flex items-start gap-3 drop-shadow-md'>
            ...
            <div className='flex flex-col items-start'>
              ...
              <p className='text-xs text-gray-500'>
                KERRY T. / Designer At{' '}
                <span className='text-blue_primary_600'>Teckzone Inc</span>
              </p>
            </div>
          </div>
        </div>
