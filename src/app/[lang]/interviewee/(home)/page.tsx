...
type JobsCenterState = {
    searchString: string;
    setSearchString: React.SetStateAction<React.Dispatch<string>>;
};

const JobsCenterContext = createContext<JobsCenterState | null>(null);

export const useJobsCenter = (): JobsCenterState => {
    const context = React.useContext(JobsCenterContext);
